    ...
    <div className="finance-page">
      ...
      <div className="finance-toolbar">
        <div className="period-filter">
          <button className={`toggle-btn ${periodType === 'month' ? 'active' : ''}`} onClick={() => setPeriodType('month')}>Месяц</button>
          <button className={`toggle-btn ${periodType === 'quarter' ? 'active' : ''}`} onClick={() => setPeriodType('quarter')}>Квартал</button>
          <button className={`toggle-btn ${periodType === 'year' ? 'active' : ''}`} onClick={() => setPeriodType('year')}>Год</button>
          <button className={`toggle-btn ${periodType === 'custom' ? 'active' : ''}`} onClick={() => setPeriodType('custom')}>Произв.</button>
          {periodType === 'custom' && (
